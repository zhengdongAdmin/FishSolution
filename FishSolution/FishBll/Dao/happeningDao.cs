...
namespace FishBll.Dao
{
    public class happeningDao
    {
        ...
        public List<FishEntity.SalesRequisitionBodyEntity> getList(string Numbering)
        {
            ...
            strSql.Append("SELECT NumberingOne,code,product_id,productname,Funit,Variety,Quantity,unitprice,Amonut,db,tvn,za,ffa,zf,sf,shy,sz,cdb,tvnOne,hf,cm,zjh,tdh,pp,Country,zaOne,ffaOne,zfOne,sfOne,shyOne,szOne FROM t_happening ");
