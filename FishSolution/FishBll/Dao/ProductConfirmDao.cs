      ...
      public DataSet GetConfirm(string where)
        {
            ...
            strSql.Append("select quotedollars,labe_water,quantity,a.id,a.code,a.name,a.brand,a.state,a.nature,a.origin,a.type,a.getinfotime,a.endinfotime,a.techtype,a.specification,a.productdate,a.shelflife,a.quality,a.manufacturers,a.factoryaddress,a.remark,a.weight,a.quality,a.remainweight,a.remainquantity,a.homemadeweight,a.homemadepackages,a.homemadecost,a.homemadeunitprice,price,arriveportdate,sailingschedule,billofgoods,agentifcompany,customsofcompany,quote_protein,quote_tvn,quote_graypart,quote_sandsalt,quote_amine,quote_ffa,quote_fat,quote_water,quote_sand,supplierid,suppliercode,supplier,linkmanid,a.linkmancode,a.linkman,latestquote,sgs_protein,sgs_tvn,sgs_graypart,sgs_sandsalt,sgs_amine,sgs_ffa,sgs_fat,sgs_water,sgs_sand,label_protein,label_tvn,label_graypart,label_sandsalt,label_amine,label_ffa,label_fat,label_sand,label_lysine,label_methionine,domestic_protein,domestic_tvn,domestic_graypart,domestic_sandsalt,domestic_sour,domestic_lysine,domestic_amine,domestic_aminototal,domestic_methionine,domestic_fat,ownercode,ownershortname,ownername,shipno,cornerno,tariffrate,samplingtime,warehouse,sgsweight,sgsquantity,goodsinfo,a.isdelete,state1,isdelete1,state2,isdelete2,state3,isdelete3,state4,isdelete4,state5,isdelete5,pack,port,quotedate,quoteweight,quotequantity,quotelife,quotermb,quotesuppliercode,quotesupplier,quotelinkmancode,quotelinkman,quoteproductyear,quoteproductdate,quotelife,quotesaildatefast,quotesaildatelate,confirmdate,confirmsgsweight,confirmsgsquantity,confirmdollars,confirmrmb,confirmagentcode,confirmagent,c.shortname as confirmshortname,confirmlinkmancode,confirmlinkman,confirmproductyear,confirmproductdate,confirmlife,confirmsaildate,a.createman as createmanX,a.createtime as createtimeX,a.modifyman as modifymanX,a.modifytime as modifytimeX from v_confirm  a ");
