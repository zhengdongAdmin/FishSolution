...
namespace FishBll.Dao
{
    public class ProductDao
    {
        ...
        public bool Update(FishEntity.ProductEntity model)
        {
            ...
            parameters[85].Value = model.State1;
            parameters[86].Value = model.State2;
            parameters[87].Value = model.State3;
            parameters[88].Value = model.State4;
            parameters[89].Value = model.State5;
            parameters[90].Value = model.Isdelete1;
            parameters[91].Value = model.Isdelete2;
            parameters[92].Value = model.Isdelete3;
            parameters[93].Value = model.Isdelete4;
            parameters[94].Value = model.Isdelete5;
            parameters[95].Value = model.Pack;
            parameters[96].Value = model.port;
            parameters[97].Value = model.id;
