...
namespace FishBll.Dao
{
    public class BillofladingDaoEx : BillofladingDao
    {
        public FishEntity.SalesRequisitionEntity getTHD(string getname)
        {
            ...
            strSql.Append("SELECT a.Numbering,a.code,demand,demandId,b.Variety,cm,zjh,tdh,c.Quantity FROM	t_salesorder a LEFT JOIN t_purchaserequisition b ON a.Purchasecontractnumber = b.ContractNo LEFT JOIN t_happening c on a.Numbering=c.NumberingOne ");
