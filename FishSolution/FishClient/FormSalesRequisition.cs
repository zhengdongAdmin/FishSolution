    ...
    public partial class FormSalesRequisition : FormMenuBase
    {
        ...
        public override void Save()
        {
            ...
            if (state == "add")
            {
                ...
                isok = _bll.ExistsNumbering(_head.Numbering);
                if (isok)
                {
        ...
        bool getValu()
        {
            ...
            _head.Supplierbool = chesupplier.Checked == true ? true : false;
            _head.Demandbool = chedemand.Checked == true ? true : false;
